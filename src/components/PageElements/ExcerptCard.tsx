    ...
    <div className="flex flex-col gap-y-3">
      <div className="flex flex-col gap-y-1">
        <h2 className="text-xl font-bold leading-snug tracking-[0.4px]">
          <Link href={link} className="transition-colors hover:text-[#40404088]">{frontmatter.title}</Link>
        </h2>
      ...
      <div className="mx-2 flex flex-col gap-y-2">
        ...
        <Link href={link}>
          <div className="flex flex-row items-center justify-end gap-x-1 text-[#1E6FBA] text-sm transition-colors hover:text-[#1E6FBA88]">
            <FontAwesomeIcon
              icon={faChevronRight}
